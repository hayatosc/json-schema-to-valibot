...
import { jsonSchemaToValibot } from '../dist/index.mjs';
...
const TEST_CATEGORIES = [
  ...
  'minLength', 'maxLength', 'pattern', 'enum', 'const', 'allOf', 'anyOf', 'oneOf',
  'not', 'items', 'minItems', 'maxItems', 'uniqueItems', 'multipleOf',
...
class TestSuiteRunner {
  ...
  private printReport(): void {
    ...
    this.categoryStats.forEach(stat => {
      const line = stat.category.padEnd(20) + 
